...
coverage run -a --source=mysql_class test/integration/mysql_class/server_fetch_slv_rep_cfg.py
...
coverage run -a --source=mysql_class test/integration/mysql_class/server_upd_slv_rep_stat.py
