...
"""Program:  slaverep_init.py
    ...
    Description:  Integration testing of SlaveRep.__init__ in mysql_class.py.
...
class UnitTest(unittest.TestCase):
    ...
    def test_tran_retry(self):
        ...
        self.assertIsNone(mysqldb.tran_retry)
    ...
    def test_conn_retry(self):
        ...
        self.assertIsNone(mysqldb.conn_retry)
    ...
    def test_no_rep_user(self):
        ...
        self.assertIsNone(mysqldb.rep_user)
