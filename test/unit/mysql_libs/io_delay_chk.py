...
"""Program:  io_delay_chk.py

    Description:  Unit testing of io_delay_chk in mysql_libs.py.

    Usage:
        test/unit/mysql_libs/io_delay_chk.py
...
class UnitTest(unittest.TestCase):
    ...
    def test_io_sync_fail_non_gtid(self, mock_delay, mock_until, mock_wait):
        ...
        with gen_libs.no_std_out():
            self.assertFalse(mysql_libs.io_delay_chk(master, slave))
