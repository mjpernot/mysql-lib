...
"""Program:  slaverep_showslvstate.py

    Description:  Unit testing of SlaveRep.show_slv_state in mysql_class.py.
...
class UnitTest(unittest.TestCase):
    ...
    def test_default(self):
        ...
        self.assertEqual(mysqlrep.show_slv_state(), (None, None, None))
